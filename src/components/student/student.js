        ...
        <>
                    ...
                    <div className="col-12 col-lg-3 d-none d-lg-block vh-100 border-start">
                        ...
                        <div className="overflow-auto h-50">
                            <h4 className="fw-bold">CIRCULARS</h4>
                            {
                                circular?.map(x => {
                                    return (
                                        <div key={Math.random()} className='p-2 shadow-sm rounded m-3' onClick={() => { openCircularDialog(x.id) }}>
                        ...
                        <div className="overflow-auto h-50">
                            <h4 className="fw-bold">REPORTS</h4>
                            {
                                reports?.map(x => {
                                    return (
                                        <div key={Math.random()} className='p-2 shadow-sm rounded m-3' onClick={() => { openReportDialog(x.id) }}>
                                            <h3>{x.reportTitle}</h3>
                                            <p className={`${ss.report_content}`}>
            ...
            {/* view circular report dialog */}
            {
                dialogData !== (undefined && []) ? (
                    <ViewCircularReports open={ViewCircularReport} closeModal={closeCircularReportDialog} data={dialogData}></ViewCircularReports>
                ) : null
            }
        </>
    );
